...
export const settingDefinitions = {
  ...
  OPENAI_MODEL: { label: 'OpenAI model', default: 'gpt-4.1-mini' },
...
function validate(key, value) {
  ...
  if (key === 'AE_SLACK_MAP') { try { JSON.parse(value || '{}'); } catch { throw new Error('AE to Slack mapping must be valid JSON'); } }
}
