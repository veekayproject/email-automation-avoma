...
export const settingDefinitions = {
  ...
  AUTOMATION_FILTERS_ENABLED: { label: 'Automation filters', default: 'false' },
  FILTER_ALLOWED_AE_EMAILS: { label: 'Allowed AE emails' },
  FILTER_TITLE_CONTAINS: { label: 'Meeting title filters', default: 'discovery' },
